...
<div class="box">
          ...
          <div class="box-content">
            <div class="box-product fixed">
                ...
                ?>
                <div class="prod_hold"> <a class="wrap_link" href="viewPages/product_details.php?id=<?PHP echo $latest_product_data['id'] ?> && category_id=<?PHP echo $latest_product_data['category_id'] ?>" > <span class="image"><img src="admin/product_image/<?PHP echo $latest_product_data['product_image']?>" alt="Spicylicious store" width="180" height="190" /></span> </a>
